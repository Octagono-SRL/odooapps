{
   ...
   https://github.com/odoo/enterprise/pulls?q=is%3Apr+state%3Aopen&page=2            'Cash Flow Statement, Cash Forecast, Customer Follow up Management, Bank Reconciliation, '
               'Cheque Printing, Automatic Currency Rates, Currency Revaluation',
